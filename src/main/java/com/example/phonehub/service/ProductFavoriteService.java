...
import com.example.phonehub.service.redis_cache.ProductFavoriteCacheService;
...
public class ProductFavoriteService {
    ...
    @Autowired private ProductFavoriteCacheService favoriteCacheService;
    ...
    public ProductFavoriteDto addFavorite(Integer userId, CreateProductFavoriteRequest req) {
        ...
        ProductFavoriteDto savedDto = ProductUtils.toDto(favoriteRepository.save(pf));
        favoriteCacheService.invalidateUserFavoritesCache(userId);
        favoriteCacheService.invalidateProductFavoriteCache(req.getProductId());
        return savedDto;
    }
    ...
    public void removeFavorite(Integer userId, Integer productId) {
        ...
        favoriteCacheService.invalidateUserFavoritesCache(userId);
        favoriteCacheService.invalidateProductFavoriteCache(productId);
    }
